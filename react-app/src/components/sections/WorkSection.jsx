import { restBase, useFetch, decodeHTMLEntities } from '../../utilities';
import WorksOverlay from '../../pages/WorksOverlay';
import { useState } from 'react';

function WorkSection() {
    const { data: restData, error } = useFetch(restBase + 'portfolio-work?_embed');
    ...
    return (
        <>
            <section id="work" className="portfolio-works" aria-labelledby="work-heading">
                ...
                <p>A collection of my best work, showcasing skills and creativity.</p>
                <div className="portfolio-featured-list">
                    {restData?.filter((work) => work.acf?.show_in_portfolio?.includes("1")).length > 0 ? (
                        restData
                            ...
                            .map((work) => (
                                ...
                                >
                                    <h3>{decodeHTMLEntities(work.title.rendered)}</h3>
