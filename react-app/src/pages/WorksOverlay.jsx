...
function WorksOverlay({ work, onClose }) {
    ...
    return ReactDOM.createPortal(
        <>
            ...
            {work && (
                <>
                    <title>{decodeHTMLEntities(work.title.rendered) || "Portfolio Project"}</title>
                    <meta
                        name="description"
                        content={
                            work.acf?.overview_description ||
                            "A detailed look at this portfolio project."
                        }
                    />
                    <meta
                        name="keywords"
                        content={
                            work.acf?.keywords ||
                            "portfolio, project, creativity, skills"
                        }
                    />
                    <meta name="author" content={work.acf?.collaboration || "Unknown Author"} />
                </>
            )}
            ...
            >
                <div className="overlay-content">
                    ...
                    <div className="overlay-text">
                        ...
                        <h1 id="overlay-title">
                            {decodeHTMLEntities(work.title.rendered)}
                        </h1>
                            ...
                            <Tabs>
                                ...
                                {work.acf["work-tabs"].map((tab, index) => (
                                    ...
                                    >
                                        {tab.tab_content?.map(
                                            (contentItem, i) =>
                                                contentItem.acf_fc_layout ===
                                                    "Highlights" &&
                                                contentItem.title &&
                                                contentItem.description ? (
                                                    <div
                                                        key={i}
                                                        className="overlay-tab-content-item"
                                                    >
                                                        <h4>
                                                            {contentItem.title}
                                                        </h4>
